...
bool XProblem::initialize()
{
	...
	// hydrostatic filling works only if gravity has only vertical component and there isn't a periodic boundary in the gravity direction
	// TODO When hydrostatic filling will be implemented to work with all directions, the disabling condition below have to be changed
